# Generated by Powerlevel10k configuration wizard on 2022-04-14 at 23:23 +07.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 53041.
# Wizard options: compatible, rainbow, ascii, 12h time, 1 line, compact, fluent,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=260
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=230
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=230
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=230
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=230
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=230
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=116
  ...
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=195
  # Custom icon.
